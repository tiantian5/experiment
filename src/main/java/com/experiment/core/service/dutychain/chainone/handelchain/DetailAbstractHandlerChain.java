 ...
 **/
public abstract class DetailAbstractHandlerChain {

    private DetailAbstractHandlerChain nextHandler;
     ...
     * @return 链路
     */
    public DetailAbstractHandlerChain getNextHandler() {
        return nextHandler;
    }
     ...
     * @return 下一个链路
     */
    public DetailAbstractHandlerChain setNextHandler(DetailAbstractHandlerChain nextHandler) {
